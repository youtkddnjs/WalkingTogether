...
public class room_fragment extends Fragment {
    ...
    roomlist_apater adapter; //현수막회사
    ArrayList<roomlist_item> items = new ArrayList<>(); //현수막들어갈데이터
    ...
    public void onResume() {
        ...
        for(int i = 0 ; i <20 ; i++){
            ...
            items.add(0,new roomlist_item("Test"+i, "00:00", "주소"));
...
//        adapter.notifyItemInserted();//아이템이 추가될때
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.roomlist_recyclerview, container,false);
        ...
        adapter = new roomlist_apater(getActivity(),items);
        //봉에게 아답터 전달
